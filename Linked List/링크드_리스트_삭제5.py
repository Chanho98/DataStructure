...
class LinkedList:
    ...
    def delete_after(self, previous_node):
        """링크드 리스트 삭제연산. 주어진 노드 뒤 노드를 삭제하고 삭제한 노드의 데이터를 출력해준다."""
...
node2 = my_list.find_node_at(2)  # 인덱스 2 노드 접근
my_list.delete_after(node2)      # 인덱스 2 뒤 데이터 삭제

print(my_list)
print(my_list.delete_after(node2))
print(my_list)